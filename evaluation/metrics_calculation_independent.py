...
# 0. Generate SAM Adjusted Segmentation

# concept_generated_0 = Image.open("../ckpts/test_2/images/A-photo-of-<asset0>-step-500.png")
concept_generated_1 = Image.open("../ckpts/test_2/images/A-photo-of-<asset1>-step-500.png")

# image_input = Image.open("../ckpts/test_2/images/A-photo-of-<asset0>-and-<asset1>-step-500.png")
image_input = Image.open("../ckpts/test/attention/0-step/image.png")
image_output_dir = "../ckpts/test_2/attention"

# inputs_mask_0 = Image.open("../ckpts/test_2/attention/0-step/final_attention0.png")
inputs_mask_1 = Image.open("../ckpts/test_2/attention/0-step/final_attention1.png")
...
for i in range(10):
    ...
    intersection = sum(sum((inputs_mask_1_np + output_mask_np) > 1))
    union = sum(sum((inputs_mask_1_np + output_mask_np) > 0))
    ...
    if IoU > IoU_max:
        ...
        output_image_masked.save(image_output_dir + "/sam_generated_test_2_masked_1.png")
...
concept_generated = concept_generated_1

with torch.no_grad():
    inputs_generated = processor_1(images=concept_generated, return_tensors="pt").to(device)
    image_features_generated = model_1.get_image_features(**inputs_generated)

concept_original = Image.open(image_output_dir + "/sam_generated_test_2_masked_1.png")
with torch.no_grad():
...
sim = (sim+1)/2
print("CLIP Independent Similarity: ", sim)
...
with torch.no_grad():
    inputs_generated = processor_2(images=concept_generated, return_tensors="pt").to(device)
...
sim = cos(image_features_generated[0], image_features_original[0]).item()
sim = (sim+1)/2
print("DINO Independent Similarity: ", sim)
